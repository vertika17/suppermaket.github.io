...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/2.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>You call, we deliver <br>Trusted by every household</h1>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>TOP PRODUCTS</h2>
                    <p class="lead">From the store to your home</p>
                </div>
                <div class="row">
						<?php 					
						$query_res= mysqli_query($db,"select * from dishes LIMIT 6"); 
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-2 food-item">
                        ...
                        <!-- <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1"> -->
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Making grocery shopping easier</h3><br>
                                    <p>Choose Fresh Mart for your online grocery needs and experience the best in 
                                        freshness, variety, and convenience. We guarantee that only the freshest products 
                                        make it to your doorstep, offering a wide range of groceries including organic and
                                         specialty items. Our user-friendly website and app make shopping easy and hassle-free, 
                                         while our fast and reliable delivery ensures your order arrives on time. Enjoy competitive 
                                         pricing with great savings, backed by exceptional customer service from our dedicated support
                                          team. We prioritize sustainability with eco-friendly packaging and support for local farmers.
                                           Plus, our easy returns and refund policy means you can shop with confidence.
                                         Make Fresh Mart your go-to online grocery store today!
                                    </p>
                                </div>
                            </div>
                        </div>
